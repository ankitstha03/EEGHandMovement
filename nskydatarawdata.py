	...
	if(object1.attention>=10 and object1.meditation>=10 and object1.poorSignal==0 and attention_value<30000):
		...
		if(cnter==512):
			...
			# if(qwe==0):
				...
				# cnter=0
				# return None
			with open('data/dataset512-'+ts+'.csv', 'ab') as f:
				writer = csv.writer(f)
		...
		if(cnter2==1024):
			...
			# if(qwe==0):
				...
				# cnter=0
				# return None
			with open('data/dataset1024-'+ts+'.csv', 'ab') as f:
				writer = csv.writer(f)
				writer.writerow([object1.attention, object1.meditation, object1.poorSignal, arr2, val2])
		...
		if(cnter3==2048):
			...
			# if(qwe==0):
				...
				# cnter=0
				# return None
			with open('data/dataset2048-'+ts+'.csv', 'ab') as f:
				writer = csv.writer(f)
				writer.writerow([object1.attention, object1.meditation, object1.poorSignal, arr3, val3])
